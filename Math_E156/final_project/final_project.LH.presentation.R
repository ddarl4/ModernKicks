...
# Better understand the influence of experimental conditions on gene expression profiles
# Reason:
# 1) important biologically (at 6hrs a drug may be doing a completly different than at 24 hours - metabolism)
# 2) High throughput experiments are expensive - if you are conducting a 
