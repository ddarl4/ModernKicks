#Math E-156 Script 2A-DataSets.R
#Based on pages 13-24 of the textbook
#The theme is how to use R to explore a data set.

#This first data set includes all flights out of LaGuardia on American and United during May and June 2009.
...
mean(delay, trim = .10) #get rid of the most extreme ten percent at each end
summary(delay) #combines lots of informative statistics
boxplot(delay) # shows the summary and all the outliers
boxplot(FlightDelays$FlightLength) #less skewed
...
#The same approach works with real data
