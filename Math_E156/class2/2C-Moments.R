#Math E-156, Script2C-Moments.R
#Covers sections A.7 and 2.7 of the textbook
...
MC3 <- mean((X-mu)^3); MC3  #zero, RRby symmetry
...
#Repeat with 10^5 samples and you will get a better result
