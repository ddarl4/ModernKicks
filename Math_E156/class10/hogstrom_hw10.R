...
prior is gamma with parameters r=15, gamma=3. Find the posterior density.
...
# hitter in the group and is therefore not worth considering. After 
# doing the problem by Bayesian methods, repeat the analysis by 
